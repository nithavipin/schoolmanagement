			...
			<div class="col-lg-6 content-right" id="start">
				<div id="wizard_container">
					<div id="top-wizard">
                          ...
                          <div>
						  <h3 class="main_question"><strong></strong>ClassRegistration</h3>
						  <form action="#"  method="post">
									<div class="form-group"><label>ClassName</label>
									
										<input type="text" name="class_name" placeholder="ClassName" class="form-control required" >
									</div>
...
$class_id = $sub_rows["class_id"];
$class_name= $sub_rows["class_name"];
...
<td><a href="<?php  echo "?delete_id=$class_id";  ?>" class="btn btn-danger" name="delete" >Delete</a>
...
if (empty($errors)) {
  ...
  $customer_delete_sql ="delete from class_master where class_id=$delete_id";
...
<?php  require __DIR__ . '/connection.php';  
  if (isset($_REQUEST["submit"]))  {  
	    $class_name=$_REQUEST['class_name'];             
		  $sql="INSERT INTO class_master( class_name) VALUES ('$class_name')";    
